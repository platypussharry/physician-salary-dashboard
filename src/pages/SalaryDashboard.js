          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="block sm:hidden">
              {recentSubmissions.filter(submission => {
                ...
                <div 
                  key={submission.id} 
                  className="bg-white rounded-lg shadow-sm p-4 mb-4 cursor-pointer hover:bg-blue-50"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="flex items-center">
                            <span className="mr-1">{submission.satisfactionLevel}/5</span>
                            {[...Array(5)].map((_, i) => (
                              <svg
                                key={i}
                                className={`w-4 h-4 ${
                                  i < submission.satisfactionLevel ? 'text-yellow-400' : 'text-gray-300'
                                }`}
                                fill="currentColor"
                                viewBox="0 0 20 20"
                              >
